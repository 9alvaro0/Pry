...
enum SessionExporter {
    ...
    static func postmanCollection(entries: [NetworkEntry], name: String = "Pry Export") -> String {
        ...
        let collection: [String: Any] = [
            "info": [
                "name": name,
                "description": "Exported from Pry on \(Date().formatted())",
    ...
    private static let skipHeaders: Set<String> = ["Content-Length", "Accept-Encoding", "Host", "X-Pry-Replay"]
