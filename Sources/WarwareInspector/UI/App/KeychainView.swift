...
struct KeychainView: View {
    ...
    private func classColor(_ className: String) -> Color {
        switch className {
        case "Generic Password": return InspectorTheme.Colors.accent
        case "Internet Password": return InspectorTheme.Colors.success
        case "Certificate": return InspectorTheme.Colors.warning
        case "Key": return InspectorTheme.Colors.syntaxBool
        default: return InspectorTheme.Colors.textTertiary
        }
    }
    ...
    private func loadItems() {
        ...
        for (secClass, className) in classes {
